        ...
        return (
            <View style={styles.wrap}>
                ...
                <View style={styles.footer}>
                    ...
                    <TouchableOpacity style={{ justifyContent: 'center', alignItems: 'center', marginHorizontal: 20 }} ><Icon name="person" style={{ fontSize: 30, color: '#57DBE9' }} /><Text style={{ fontSize: 10, marginTop: -5, color: '#57DBE9' }}>Account</Text></TouchableOpacity>
                </View>
            </View>
        )
    }
